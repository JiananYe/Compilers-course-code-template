...
public sealed abstract class BinaryOperationNode extends Node permits AddNode, DivNode, ModNode, MulNode, SubNode, GreaterNode, LessNode, GreaterEqualNode, LessEqualNode, EqualNode, NotEqualNode, ShlNode, ShrNode {
